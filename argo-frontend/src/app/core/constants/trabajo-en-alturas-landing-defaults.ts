/** Página /trabajo-en-alturas — contenido editable desde el ERP (defaults). */
...
const IMG = (
  ...
  alt: string,
  promptImagen: string,
): TaImagen => ({ id, etiqueta, url: '', alt, promptImagen });
...
export const TRABAJO_EN_ALTURAS_LANDING: PortalTrabajoEnAlturasLanding = {
  ...
  imagenes: [
    IMG(
      'hero',
      'Imagen principal',
      'Trabajador en alturas sector transporte',
    ...
    IMG(
      ...
      'Operaciones en altura sector transportador',
      promptFotoHorizontal(
    ...
    IMG(
      'normativa',
      'Sección normativa',
      'Marco jurídico trabajo en alturas',
      promptFotoHorizontal(
