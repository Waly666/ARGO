...
export interface MpDocumentoGrupo {
  id: string;
  kicker: string;
  titulo: string;
  lead: string;
...
const DOC = (file: string) => `/documents/mercancias-peligrosas/${file}`;

export const MERCANCIAS_PELIGROSAS_DOCUMENTOS_GRUPOS: MpDocumentoGrupo[] = [
  {
    id: 'normativa',
