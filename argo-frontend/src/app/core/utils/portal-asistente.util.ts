...
} from '../constants/portal-landing-defaults';
...
export const PORTAL_ASISTENTE_PAGINAS: {
  ...
  { key: 'cursosConduccion', titulo: 'Cursos conducción', descripcion: 'Categorías de licencia y resoluciones' },
...
export function mergePortalAsistente(
  ...
  return {
    videoUrl,
    videoUrlAbsoluta: raw?.videoUrlAbsoluta?.trim() || legacyConsulta?.asistenteVideoUrlAbsoluta?.trim(),
    paginas,
  };
}
