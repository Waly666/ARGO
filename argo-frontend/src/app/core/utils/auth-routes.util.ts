...
const RUTAS_INICIO: { path: string; permiso: string | string[] }[] = [
  ...
  { path: '/app/contabilidad/inicio', permiso: ['contabilidad', 'caja.admin'] },
...
const REGLAS_RUTA: { prefix: string; permiso: string | string[] }[] = [
  ...
  { prefix: '/app/contabilidad/facturacion', permiso: ['contabilidad', 'facturacion', 'caja.admin'] },
  { prefix: '/app/contabilidad', permiso: ['contabilidad', 'caja.admin'] },
