...
const RUTAS_INICIO: { path: string; permiso: string | string[] }[] = [
  ...
  { path: '/app/jornadas/clases-en-desarrollo', permiso: ['jornadas.ver', 'jornadas.gestionar', 'jornadas.operar'] },
...
const REGLAS_RUTA: { prefix: string; permiso: string | string[] }[] = [
  ...
  { prefix: '/app/aula-virtual/sitio', permiso: ['aula_virtual.sitio', 'aula_virtual.gestionar'] },
  { prefix: '/app/aula-virtual/blog', permiso: ['aula_virtual.sitio', 'aula_virtual.gestionar'] },
  { prefix: '/app/aula-virtual/foro', permiso: ['aula_virtual.foro', 'aula_virtual.gestionar'] },
  {
    prefix: '/app/aula-virtual',
  ...
  { prefix: '/app/contabilidad/facturacion', permiso: ['contabilidad', 'facturacion'] },
  { prefix: '/app/contabilidad', permiso: 'contabilidad' },
  ...
  { prefix: '/app/caja/gestores', permiso: ['caja.turno', 'caja.admin', 'contabilidad'] },
  { prefix: '/app/caja/gestores/informe', permiso: ['caja.turno', 'caja.admin', 'contabilidad'] },
  { prefix: '/app/caja/empresa', permiso: ['caja.turno', 'caja.admin', 'contabilidad'] },
  ...
  { prefix: '/app/informes/matriculas-virtuales', permiso: ['aula_virtual.informes', 'aula_virtual.gestionar', 'informes.ver', 'alumnos.ver'] },
  ...
  { prefix: '/app/configuracion/jornadas', permiso: 'jornadas.gestionar' },
  { prefix: '/app/configuracion/alertas', permiso: ['config.alertas', 'config.roles'] },
  { prefix: '/app/configuracion/paginas-informes', permiso: ['config.paginas_informes', 'config.roles'] },
