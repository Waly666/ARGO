...
El titular de la información suministrada, podrá ejercer cualquiera de los derechos mencionados, dirigiendo una petición en este sentido al correo institucional del Centro de Enseñanza Automovilística.

(*) Datos Sensibles: Aquellos que afectan la intimidad del Titular o cuyo uso indebido puede generar su discriminación.

Autorizada la solicitud en los términos dispuestos por el ${DEFAULT_CEA_NOMBRE}, se le dará trámite al requerimiento según lo establecido por la ley.`;

const CANAL_CONSENTIMIENTO = {
  JORNADAS: 'WEB_JORNADAS',
  AULA_VIRTUAL: 'WEB_AULA_VIRTUAL',
};
