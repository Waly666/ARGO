const ESTADO_JORNADA_PROGRAMADA = 'PROGRAMADA';
...
/** Certificado del contrato: global (numSesCert) o uno por cada clase. */
const TIPO_CERTIFICADO_GLOBAL = 'global';
const TIPO_CERTIFICADO_POR_CLASE = 'por_clase';
const TIPOS_CERTIFICADO_CONTRATO = [TIPO_CERTIFICADO_GLOBAL, TIPO_CERTIFICADO_POR_CLASE];
