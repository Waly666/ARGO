...
const ETIQUETAS = {
  ...
  colegios: 'Instituciones educativas (colegios / IES)',
  estamentosPublicos: 'Estamentos públicos (jornadas)',
...
const ID_FIELDS_HINT = {
  ...
  talleres: ['idTaller'],
  carpas: ['idCarpa'],
  colegios: ['codigoEstablecimiento'],
  estamentosPublicos: ['idEstamento'],
