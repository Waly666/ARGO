...
import {
  SERVIAL_ENLACES_CURSOS_CONDUCCION,
...
export const CC_SEO_DESCRIPTION =
  'CEA SERVIAL Colombia: cursos de conducción A2, B2, C1, C2 y C3 en Villavicencio, Meta. Formación teórica, práctica y de taller para conductores seguros y responsables.';
export const CC_SEO_KEYWORDS =
...
export const CC_MAPS_URL =
  'https://www.google.com/maps/search/?api=1&query=Calle+37B+%2319A-65,+Villavicencio,+Meta,+Colombia';
export const CC_WHATSAPP_URL = 'https://wa.me/573213039595';
export const CC_WHATSAPP_DISPLAY = '321 303 9595';
export const CC_TELEFONO_DISPLAY = '316 406 3074';
export const CC_DIRECCION = 'Calle 37B #19A-65, barrio Jordán, Villavicencio, Meta.';

export const CC_HERO = {
...
export const CC_METODOLOGIA = {
  titulo: 'Formación Teórica, Práctica y de Taller',
  lead:
...
export const CC_REQUISITOS = {
  titulo: 'Requisitos para realizar un Curso de Conducción',
  lead:
  ...
  licenciaTexto: '¿Quieres conocer el proceso para obtener tu licencia?',
  licenciaEnlaceTexto: 'Consulta los requisitos para la licencia de conducción',
  btnTexto: 'Ver requisitos para la licencia de conducción',
  btnUrl: CC_LICENCIAS_URL,
};

export const CC_SEO_TEXTO = {
  titulo: 'Escuela de Conducción en Villavicencio, Meta',
  parrafos: [
...
export const CC_FAQ_TITULO = 'Preguntas Frecuentes sobre Cursos de Conducción';
...
export const CC_ENLACES_RELACIONADOS_TITULO = SERVIAL_ENLACES_TITULO;
export const CC_ENLACES_RELACIONADOS = SERVIAL_ENLACES_CURSOS_CONDUCCION;

export const CC_INSCRIPCIONES = {
  titulo: 'Inscripciones a Cursos de Conducción en Villavicencio',
  lead: 'Realice su formación como conductor con CEA SERVIAL Colombia en Villavicencio.',
};

export const CC_LOCAL = {
  titulo: 'Cursos de Conducción en Villavicencio, Meta',
  lead:
    'Consulte disponibilidad, requisitos y horarios para las categorías A2, B2, C1, C2 y C3.',
  btnMapsTexto: 'Cómo llegar a SERVIAL',
