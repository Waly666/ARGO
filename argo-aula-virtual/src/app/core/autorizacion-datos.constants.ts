...
/**
 * Construye el texto legal usando el nombre y correo de la empresa/entidad
 * configurada en el portal. Si no se proveen, se usan textos genéricos.
 */
...
/** Texto por defecto (sin datos de empresa) para compatibilidad. */
export const AUTORIZACION_DATOS_TEXTO = buildAutorizacionDatosTexto();
